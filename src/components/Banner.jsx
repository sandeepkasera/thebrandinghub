...
export default function Banner() {
  return (
    <section id="top" className="relative overflow-hidden bg-[radial-gradient(circle_at_top,_rgba(255,214,75,0.25),_transparent_45%),linear-gradient(180deg,_rgb(248,250,252),_rgb(255,255,255))] py-16 sm:py-20">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div className="space-y-6 sm:space-y-8">
            <p className="inline-flex rounded-full bg-amber-100 px-4 py-2 text-xs font-semibold uppercase tracking-[0.35em] text-amber-700 sm:text-sm">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              <a href="#contact" className="inline-flex w-full justify-center rounded-full bg-amber-500 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-amber-300/30 transition hover:bg-amber-600 sm:w-auto">
                Book a Strategy Call
              </a>
              <a href="#services" className="inline-flex w-full justify-center rounded-full border border-slate-300 bg-white px-6 py-3 text-sm font-semibold text-slate-900 transition hover:border-slate-400 sm:w-auto">
                Explore Services
              </a>
            </div>
          </div>

          <div className="space-y-6 rounded-[2rem] border border-slate-200 bg-white/90 p-6 shadow-2xl backdrop-blur-xl sm:p-8">
